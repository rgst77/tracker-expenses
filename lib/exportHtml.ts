...
const LOGO_SVG = `<svg class="logo" width="36" height="36" viewBox="0 0 36 36" role="img" aria-label="Expenses Tracker">
  <defs><linearGradient id="logo-grad" x1="0" y1="0" x2="1" y2="1">
    <stop offset="0" stop-color="var(--series-1)" /><stop offset="1" stop-color="var(--series-6)" />
  </linearGradient></defs>
  <rect width="36" height="36" rx="9" fill="url(#logo-grad)" />
  <rect x="9" y="20" width="4.5" height="9" rx="1.5" fill="white" fill-opacity="0.95" />
  <rect x="15.75" y="14" width="4.5" height="15" rx="1.5" fill="white" fill-opacity="0.95" />
